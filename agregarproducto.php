    ...
    <div class="container">
        ...
        <form method="post" id="form" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" maxlength="255" value="<?php echo htmlspecialchars($nombre); ?>">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" rows="2" maxlength="255"><?php echo htmlspecialchars($descripcion); ?></textarea>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="precio" name="precio" placeholder="Precio" value="<?php echo htmlspecialchars($precio); ?>">
                    ...
                    <?php foreach ($tallas as $index => $tallaItem) : ?>
                        <?php if ($index % $colSize === 0) : ?>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="talla_<?php echo $tallaItem['Id_Talla']; ?>" name="talla[]" value="<?php echo $tallaItem['Id_Talla']; ?>">
                                <label class="form-check-label" for="talla_<?php echo $tallaItem['Id_Talla']; ?>">
                                    <?php echo $tallaItem['Descripcion']; ?>
                                </label>
                                <input type="number" class="form-control" id="cantidad_<?php echo $tallaItem['Id_Talla']; ?>" name="cantidad[<?php echo $tallaItem['Id_Talla']; ?>]" placeholder="Cantidad">
                            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="categoria" name="categoria">
                    ...
                    <?php foreach ($categorias as $categoriaItem) : ?>
                        <option value="<?php echo $categoriaItem['Id_Categoria']; ?>" <?php if ($categoria == $categoriaItem['Id_Categoria']) echo 'selected'; ?>>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="subcategoria" name="subcategoria">
                    ...
                    <?php foreach ($subcategorias as $subcategoriaItem) : ?>
                        <option value="<?php echo $subcategoriaItem['id_SubCategoria']; ?>" <?php if ($subcategoria == $subcategoriaItem['id_SubCategoria']) echo 'selected'; ?>>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="proveedor" name="proveedor">
                    ...
                    <?php foreach ($proveedores as $proveedorItem) : ?>
                        <option value="<?php echo $proveedorItem['Id_Proveedor']; ?>" <?php if ($proveedor == $proveedorItem['Id_Proveedor']) echo 'selected'; ?>>
