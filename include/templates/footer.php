...
<footer class="text-center bg-body-tertiary">
    ...
    <div class="container pt-4">
        ...
        <section class="">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 mx-auto mb-4">
                    ...
                    <p>
                        Número: <span>+(506)2215-4410</span>
                    </p>
                    <p>
                        Correo: <span>estesriaelcorreo@correo.com</span>
                    </p>
                    <p>
                        300 mts oeste frente a la iglesia de los mormones, Alajuela, Costa Rica
                    </p>
                </div>
                <!-- Grid column -->
            </div>
        ...
        <section class="mb-4">
            ...
            <a data-mdb-ripple-init class="btn btn-link btn-floating btn-lg text-body m-1" href="https://github.com/Danyy22-oi/Proyecto-Ambiente-web-cliente-servidor" role="button" data-mdb-ripple-color="dark"><i class="fab fa-github"></i></a>
        </section>
        <!-- Section: Social media -->
    </div>
    <!-- Grid container -->
    ...
    <!-- Copyright -->
    <div class="text-center p-3 bg-footer-final">
        © 2024 Copyright:
        Todos los derechos reservados
    </div>
    <!-- Copyright -->
</footer>
<script src="../../js/scriptRangeBar.js"></script>
